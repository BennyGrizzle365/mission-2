...
//   }
// }
// // onclick / on select  for triggering loading of the table
// // probably using this  populateDataTable() in the onclick trigger

// function populateDataTable() {
//   const selectElement = document.getElementById(`dataTable`);

//   const thead = document.createElement("thead");
//   const headerRow = document.createElement("tr");
//   const header = [`Stop Name`, `Times`];
//   Headers.forEach((headerText) => {
//     const th = document.createElement(`th`);
//     th.content = headerText;
//     headerRow.appendChild(th);
//   });
...
//   for (let i = 0; i < busRoutes.stops.length; i++) {
//     const stop = busRoutes.stop[i];
//     const row = documetn.createElement(`tr`);
//     const stopCell = document.createElement(`td`);
//     stopCell.textContent = stop.stopName;
//     row.appendChild(stopCell);

//     const timeCells = document.createElement(`td`);
//     timeCells.textContent = stop.times.join(`, `);
//     row.appendChild(row);
//   }
//   dataTable.appendChild(tbody);
// }
